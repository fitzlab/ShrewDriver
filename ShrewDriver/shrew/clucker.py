...
def load_parameters(task):
    ...
    task.commandStrings[States.SMINUS] = 'as sf0.25 tf0 jf0 ja0 gc0.75 px0 py0 sx999 sy999\n'
    task.commandStrings[States.GRAY] = 'sx0 sy0\n'
    task.commandStrings[States.SPLUS] = 'as sf0.25 tf0 jf0 ja0 gc0.75 px0 py0 sx999 sy999\n'
